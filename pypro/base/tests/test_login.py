...
def test_link_login_disponivel(resp_home):
    assert_contains(resp_home, f'{reverse("login")}"')


@pytest.fixture
def resp_home_com_usuario_logado(client_usuario_logado):
...
def teste_link_logout_disponivel(resp_home_com_usuario_logado):
